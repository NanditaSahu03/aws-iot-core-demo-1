...
awshost = secrets.get_secret()     # Endpoint
awsport = 8883                                              # Port no.   
clientId = "aws-iot"                                     # Thing_Name
thingName = "aws-iot"                                    # Thing_Name
caPath = "certificates/AmazonRootCA1.pem" #Amazon's certificate from Third party                                     # Root_CA_Certificate_Name
certPath = "certificates/c78567474747-certificate.pem.crt"   # <Thing_Name>.cert.pem.crt. Thing's certificate from Amazon
keyPath = "certificates/c78567474747.pem.key"        # <Thing_Name>.private.key Thing's private key from Amazon
...
while 1:
    ...
    if connflag == True:
        ...
        mqttc.publish("temp-press-topic", message, 1)        # topic: temp-press-topic # Publishing Temperature values
